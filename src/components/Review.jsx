  ...
  return (
    <section id='review' className='container mx-auto mb-8 mt-12'>
        <motion.div 
            initial='hidden'
            whileInView='show'
            variants={conrainerVariants}
            viewport={{ once: true }}
            className='flex flex-col'>
            <motion.p 
                variants={itemVariants}
                className='mb-10 text-3xl font-light leading-normal tracking-tighter lg:mx-40  lg:mt-40 lg:text-[3.5rem]'>{REVIEW.content}</motion.p>
            <motion.div 
                variants={itemVariants}
